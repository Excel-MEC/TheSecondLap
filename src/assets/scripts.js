...
var Countdown = {
  ...
  init: function() {
        ...
        var _yr=2017, _m=8, _d=13, _t='7:.00'
        var _today = new Date();
...
function calculateAndDisplayRoute(directionsDisplay, directionsService,
	...
	directionsService.route({
		origin: 'Cochin Port Trust Stadium,Bristow Rd Willingdon Island Kochi Kerala',
 ...
 // 		if (i%3==0) {
 // 			$(".gold").delay(2000).fadeOut();
 //     		$(".yesbank").delay(2000).fadeIn();
 // 		}
 // 		else if (i%3==1) {
 // 			$(".yesbank").delay(2000).fadeOut();
 // 			$(".medical").delay(2000).fadeIn();
 // 		}
 // 		else {
